...
printf "${BLUE}# $num: %-69s  []${NC}" "$description"
$PROJECT_DIRECTORY/pipex "assets/deepthought.txt" "cat" "ls" "outs/test-14.txt" > outs/test-14-tty.txt 2>&1
...
description="The output of the command is correct"
printf "${BLUE}# $num: %-69s  []${NC}" "$description"
$PROJECT_DIRECTORY/pipex "assets/deepthought.txt" "grep Now" "head -2" "outs/test-16.txt" > outs/test-16-tty.txt 2>&1
...
description="The output of the command is correct"
printf "${BLUE}# $num: %-69s  []${NC}" "$description"
$PROJECT_DIRECTORY/pipex "assets/deepthought.txt" "grep Now" "wc -w" "outs/test-18.txt" > outs/test-18-tty.txt 2>&1
...
description="The output of the command is correct"
printf "${BLUE}# $num: %-69s  []${NC}" "$description"
$PROJECT_DIRECTORY/pipex "assets/deepthought.txt" "notexisting" "wc" "outs/test-23.txt" > outs/test-23-tty.txt 2>&1
...
description="The output of the command is correct"
printf "${BLUE}# $num: %-69s  []${NC}" "$description"
$PROJECT_DIRECTORY/pipex "assets/deepthought.txt" "cat" "notexisting" "outs/test-26.txt" > outs/test-26-tty.txt 2>&1
...
printf "${BLUE}# $num: %-69s  []${NC}" "$description"
$PROJECT_DIRECTORY/pipex "/dev/urandom" "cat" "head -1" "outs/test-27.txt" > outs/test-27-tty.txt 2>&1 &
i=0
bg_process=$!
